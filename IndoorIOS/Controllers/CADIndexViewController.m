...
#import "CADIndexViewController.h"
#import "CADIndexCollectionViewCell.h"
...
#import "CADIndexHeaderView.h"
#import "CADIndexFooterView.h"
#import <BaiduMapAPI_Utils/BMKUtilsComponent.h>

@interface CADIndexViewController ()
...
@implementation CADIndexViewController
...
- (UICollectionViewCell*) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CADIndexCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"indexCell" forIndexPath:indexPath];

    [cell LoadCell:[[NSString alloc] initWithFormat:@"%ld",(long)indexPath.row] ];
...
- (UICollectionReusableView*) collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    if (kind == UICollectionElementKindSectionHeader) {
        ...
        CADIndexHeaderView *headerView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"headerView" forIndexPath:indexPath];
    ...
    if (kind == UICollectionElementKindSectionFooter){
        CADIndexFooterView *footerView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:@"footerView" forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section < _logArray.count) {
    } else {
        NSDictionary *parameters = @{@"token":[self.project objectForKey:@"token"], @"projectCode":[[self.project objectForKey:@"project"][_projectIndex] objectForKey:@"code"],@"projectName":[[self.project objectForKey:@"project"][_projectIndex] objectForKey:@"name"],@"subProjectName":_currentAreaArr[_projectIndex], @"childCode":[_anaArray[indexPath.section - _logArray.count] objectForKey:@"code"],@"childName":[_anaArray[indexPath.section - _logArray.count] objectForKey:@"name"],@"childUnit":[_anaArray[indexPath.section - _logArray.count] objectForKey:@"unit"]};
        [self performSegueWithIdentifier:@"chart" sender:parameters];
    }
